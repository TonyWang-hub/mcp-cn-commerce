...
@pytest.mark.asyncio
async def test_get_inventory_returns_inventory_with_sku_details(
...
@pytest.mark.asyncio
async def test_get_bill_list_returns_bills_with_expected_fields(
    mock_call, bill_list_payload
):
